...
function windowLoadInit() {
	...
	jQuery('form.contact-form').on('submit', function( e ){
		...
		var ajax = jQuery.post( "http://webdesign-finder.com/html/pharma/js/contact-form.php", request )
		.done(function( data ) {
	...
	jQuery('form.searchform').on('submit', function( e ){
		...
		//sending form data to PHP server if fields are not empty
		var request = $form.serialize();
		var ajax = jQuery.post( "http://webdesign-finder.com/html/pharma/js/search.php", request )
		.done(function( data ) {
	...
	jQuery('.signup').on('submit', function( e ) {
		...
		jQuery.ajax({
			url: 'http://webdesign-finder.com/html/pharma/js/mailchimp/store-address.php',
	...
	//see 'plugins.js'/*tpa=http://webdesign-finder.com/html/pharma/js/plugins.js*/ file
	...
	if (jQuery().elevateZoom) {
		jQuery('#product-image').elevateZoom({
			...
			responsive:true, 
			loadingIcon: 'img/AjaxLoader.gif'/*tpa=http://webdesign-finder.com/html/pharma/js/img/AjaxLoader.gif*/
		});
	}
	...
	jQuery('.review-link').on('click', function( e ) {
		...
		if (!reviewTabLink.parent().hasClass('active')) {
			reviewTabLink
			.tab('show')
			.on('http://webdesign-finder.com/html/pharma/js/shown.bs.tab', function (e) {
	...
	if (jQuery().appear) {
		...
		if (jQuery().progressbar) {
			...
			jQuery('a[data-toggle="tab"]').on('http://webdesign-finder.com/html/pharma/js/shown.bs.tab', function(e) {
...
$window.on('load', function(){
	...
	if ( $googleMaps.length ) {
		$googleMaps.each(function() {
			...
			var styles = [{"featureType": "administrative","elementType": "http://webdesign-finder.com/html/pharma/js/labels.text.fill","stylers": [{"color": "#444444"}]},{"featureType": "landscape","elementType": "all","stylers": [{"color": "#f2f2f2"}]},{"featureType": "poi","elementType": "all","stylers": [{"visibility": "off"}]},{"featureType": "road","elementType": "all","stylers": [{"saturation": -100},{"lightness": 45}]},{"featureType": "road.highway","elementType": "all","stylers": [{"visibility": "simplified"}]},{"featureType": "road.arterial","elementType": "http://webdesign-finder.com/html/pharma/js/labels.icon","stylers": [{"visibility": "off"}]},{"featureType": "transit","elementType": "all","stylers": [{"visibility": "off"}]},{"featureType": "water","elementType": "all","stylers": [{"color": "#0095b3"},{"visibility": "on"}]}];
