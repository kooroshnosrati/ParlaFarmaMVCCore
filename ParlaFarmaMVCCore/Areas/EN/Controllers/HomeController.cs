...
namespace ParlaFarmaMVCCore.Areas.EN.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public List<string[]> DictStr = new List<string []>()
        {
            ...
            new string []{ "97", "Message", "Mesajınız", "" },
            new string []{ "98", "Send Message", "Göndər", "" },
            new string []{ "99", "Our Product Strategy", "Məhsul strategiyamız", "" },
            new string []{ "100", "Parla has mainly been established to be an international player in pharmaceutical sector. In order to achieve such ambitious goals, there is a mandate internally to focus on <strong>QUALITY OF PRODUCTS</strong>. Parla is committed to provide high quality products with affordable price. Based on this strategy, Parla has defined its own product strategy very clear.", "Parla əczaçılıq sektorunda beynəlxalq oyunçulardan birinə çevrilməyi hədəfləyir. Bu cür iddialı məqsədlərə çatmaq üçün <strong>MƏHSULLARIN KEYFİYYƏTİ ƏSAS</strong> meyardır. Parlanın əsas missiyalarından biri münasib qiymətə yüksək keyfiyyətli məhsullar təqdim etməkdir. Parla özünün məhsul strategiyasını bu meyarlara əsaslanaraq müəyyən etmişdir.", "" },
            ...
            new string []{ "121", "Improving health care access and quality of life", "Səhiyyə xidmətlərinə çıxışı və pasiyentlərin həyat keyfiyyətini yaxşılaşdırmaq", "" },
            new string []{ "122", "Creating added value for  our customers, staff, business partner and  shareholders", "Müştərilərimiz, əməkdaşlarımız, biznes tərəfdaşlarımız və səhmdarlarımız üçün əlavə dəyər yaratmaq", "" },
