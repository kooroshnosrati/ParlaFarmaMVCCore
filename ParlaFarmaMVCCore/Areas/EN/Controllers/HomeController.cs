...
namespace ParlaFarmaMVCCore.Areas.EN.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public List<string[]> DictStr1 = new List<string[]>(){new string[]{ "0", "Working Hours: Mon - Fri 9:00 – 18:00", "İş saatları: Mon - Fri 9:00 - 18:00", "" },
...
new string[]{ "51", "To have a sustainable business, Parla is responsible for its society and environment. We collaborate with related stakeholders in our disease areas as a part of corporate social responsibility activities. Also, to keep our planet safe for all of us, we have some policies which underpins every decision and action we make.", "Biznesin dayanıqlılığına nail olmaq üçün Parla öz qarşısına cəmiyyət və ətraf mühitlə bağlı məsuliyyətlər qoyub. Biz bütün fəaliyyətimizdə bu korporative sosial məsuliyyət öhdəliklərini qəbul edir və bu istiqamətdə müvafiq tərəflərlə əməkdaşlıq edərək Korporativ Sosial Məsuliyyət (KSM) layihələri həyata keçiririk.", "" },
...
new string[]{ "133", "<p>Parla Pharmaceuticals is a pioneer in Azerbaijan to be the first science-based pharmaceutical company. Our aim is to improve healthcare access and quality of life. To touch more lives and to contribute to a better future we need to attract highly qualified professionals and young potentials.</p> <p>Parla is thrilled to launch “Parla Youth Academy” to help students and graduates have great impact on the business and gain real-life experience, also have opportunity to start and pursue their careers at Parla Pharmaceuticals. “Parla Youth Academy” will cover various internship programs at different departments which offer new opportunities for young candidates. Through paid internship programs under “Parla Youth Academy” selected candidates will receive several trainings from professionals, gain hands-on experience working on challenging, meaningful projects with guidance from a mentor and other members of Parla team.</p> <p></p> <b>Parla Sales Program</b><br/><p>Initially, “Sales Program” under “Parla Youth Academy” has been launched and more than 700 applications received for the opening. After shortlisting candidates and final selection stages, 2 of them have been selected and started their life changing journey at Parla. Participants who successfully complete the internship program will have an opportunity to be part of Parla Pharmaceuticals team. </p><p> For more information on positions under “Parla Youth Academy” see our <a href=\"/EN/Home/Career\">Careers</a> section. Internship programs are advertised on the <a href=\"/EN/Home/Career#Vacancies\">Vacancies</a> section regularly.</p>", "<p>Parla Pharmaceuticals Azərbaycanda ilk elmi əsaslı əczaçılıq şirkətidir. Məqsədimiz səhiyyə xidmətlərini daha əlçatan etmək və həyat keyfiyyətini yaxşılaşdırmaqdır. Bu məqsədlə, daha çox həyata toxunmaq və daha yaxşı gələcəyə öz töhfəmizi vermək üçün biz yüksək ixtisaslı mütəxəssisləri və gənc potensialları cəlb etməliyik. </p><p> Parla Pharmaceuticals tələbə və məzunların iş dünyası ilə tanış olmaları və real həyatda təcrübə qazanmalarına, Parla Pharmaceuticals-da öz karyeralarına başlamaq fürsəti qazanmaları üçün “Parla Gənclər Akademiyası” layihəsinə start vermişik. “Parla Gənclər Akademiyası” gənc namizədlər üçün müxtəlif sahələrdə təcrübə proqramlarını əhatə edəcək. Bu layihə çərçivəsində Parla tərəfindən ödənişli təcrübə proqramları vasitəsilə seçilən namizədlər peşəkar mütəxəssislərdən müxtəlif təlimlər alacaq, mentorlarən və Parla komandasının digər üzvlərinin köməyi ilə maraqlı və çətin layihələr üzərində real iş təcrübəsi qazanacaqlar. </p><p></p> <b>Satış üzrə Təcrübə Proqramı</b><br/> <p>İlkin olaraq, “Parla Gənclər Akademiyası” nəzdində “Satış üzrə Təcrübə Proqramı” start götürüb. Proqram üçün 700-dən çox namizədin müraciəti qəbul olunub. Namizədlərin son seçim mərhələlərindən sonra istedadlı 2 gənc layihədə iştirak haqqı qazanıb və “Parla Pharmaceuticals”da öz karyera yoluna başlayıb. Təcrübə proqramını uğurla başa vuran iştirakçılar Parla Pharmaceuticals komandasının üzvü olmaq şansı qazanacaqlar. </p><p> “Parla Gənclər Akademiyası” çərçivəsində elan olunan təcrübə proqramları haqqında daha çox məlumat üçün internet səhifəmizdə <a href=\"/EN/Home/Career?lang=az\">Karyera</a> bölməsinə nəzər salın. Təcrübə proqramları <a href=\"/EN/Home/Career?lang=az#Vacancies\">Vakansiyalar</a> bölməsində mütəmadi olaraq elan olunur. </p>", "" },
new string[]{ "134", "Parla Pharmaceuticals is thrilled to launch “Parla Youth Academy”", "Parla Pharmaceuticals şirkəti “Parla Gənclər Akademiyası”-na start verib.", "" },
new string[]{ "135", "“Parlasın Azərbaycan!” project", "“Parlasın Azərbaycan!” layihəsi", "" },
...
new string[]{ "151", "", "Parla Pharmaceuticals ölkədə yerli dərman istehsalını dəstəkləmək məqsədilə avgust ayında “Parlasın Azərbaycan!” adlı yeni layihəyə start verdi. Şirkətimiz indiyədək yüksək səviyyəli dövlət qurumlarından, səhiyyə mütəxəssislərindən, yerli distribyutorlar və əhali tərəfindən böyük dəstəklə qarşılanıb və biz inanırıq ki, “Made in Azerbaijan” brendi altında istehsal olunan keyfiyyətli dərman vasitələri ilə pasiyentlərin həyat keyfiyyətini yaxşılaşdıra bilərik. Hər birinizi Azərbaycanda yüksək keyfiyyətli dərman vasitələrinin istehsalı ilə bağlı bu layihəni dəstəkləməyə dəvət edirik!", "" },
new string[]{ "152", "", "Uşaqların gələcəyi, cəmiyyətimizin gələcəyidir! Parla Pharmaceuticals olaraq biz Korporativ Sosial Məsuliyyət çərçivəsində uşaqların idmana olan marağını dəstəkləyirik. Daha sağlam həyat və daha parlaq gələcək naminə hər zaman onların yanındayıq. Uşaqların gələcəyi, cəmiyyətimizin gələcəyidir!", "" },
new string[]{ "153", "", "Parla Pharmaceuticals şirkətinin yerli istehsala dəstək məqsədilə start verdiyi <q>Parlasın Azərbaycan</q> adlı layihəsinə Azərbaycanın ən böyük şokolad fabriki olan <q>Ulduz</q> fabriki də dəstək göstərib. <q>Ulduz</q> fabriki əməkdaşlıq çərçivəsində Əczaçıların II Ümumrespublika konfrans iştirakçılarını yerli istehsal olan dadlı və keyfiyyətli şokoladları ilə məmnun edib. <q>Parlasın Azərbaycan</q> layihəsi  ölkəmizdə yerli istehsalın inkişafı və təşviqini hədəfləyib və qısa zaman ərzində böyük maraq toplayıb.", "" },
new string[]{ "154", "", "Oktyabrın 1-də ölkə əczaçılarının 2-ci Ümumrespublika konfransı baş tutub. Tədbirdə dövlət və özəl qurumların nümayəndələri, yerli və xarici əczaçılıq şirkətləri, o cümlədən praktik, elmi-tədqiqat və tədris sahəsində fəaliyyət göstərən əczaçılar iştirak ediblər. Tədbirdə Parla Pharmaceuticals şirkətinin direktoru Arash Nosrati Heravi da çıxış edib və o, yerli dərman istehsalının əhəmiyyətindən bəhs edib. Eyni zamanda şirkətin direktoru yerli dərman istehsalına dəstək ilə bağlı olan “Parlasın Azərbaycan” layihəsini təqdim edib və bütün tədbir iştirakçılarını layihəyə dəstək göstərməyə çağırıb.", "" },
new string[]{ "155", "The future of children is the future of our society!", "Uşaqların gələcəyi, cəmiyyətimizin gələcəyidir! ", "" },
new string[]{ "156", "Support of local producers ", "Yerli istehsalçıların dəstəyi", "" },
new string[]{ "157", "2nd National Conference of Pharmacists", "Əczaçıların 2-ci Ümumrespub-lika konfransı", "" },
new string[]{ "158", "Parla Youth Academy", "Parla Gənclər Akademiyası", "" },
new string[]{ "159", "Visit from Colombia’s Ambassador ", "Kolumbiya səfiri ilə görüş", "" },
new string[]{ "160", "Visit from Argentina’s Ambassador", "Argentina səfiri ilə görüş", "" },
new string[]{ "161", "Antibiotics", "Antibiotiklər", "" },
new string[]{ "162", "Antifungal", "Endokrinologiya", "" },
new string[]{ "163", "Cardiovascular", "Göbələkəleyhinə", "" },
new string[]{ "164", "Endocrinology", "Kardiologiya", "" },
new string[]{ "165", "Urology", "Urologiya", "" },
new string[]{ "166", "By Category", "Kateqoriyaya görə", "" },
...
new string[]{ "172", "3rd EndoUpdate event went perfectly by active participation of young and talented endocrinologists and other specialties doctors, they shared their knowledge about “Disorders of water and salt metabolism” in a very positive and specific atmosphere. <br/>The event was organized with the support of “Parla Pharmaceuticals” under Corporate Social Responsibility program.", "30 iyun tarixində gənc endokrinoloq və başqa ixtisas həkimlərin iştirakı ilə 3-cü “EndoUpdate” tədbiri keçirilib. Tədbir zamanı “Su-duz mübadiləsinin pozğunluqları” mövzusunda çıxışlar oldu, birgə fikir mübadiləsi aparılıb və ətraflı sual-cavab sessiyası baş tutub. <br/>Tədbir “Parla Pharmaceuticals” şirkətinin dəstəyi ilə Korporativ Sosial Məsuliyyət proqramı çərçivəsində keçirilib.", "" }
        ...
        public HomeController(ApplicationDbContext applicationDbContext, IWebHostEnvironment webHostEnvironment, IHttpContextAccessor accessor)
        {
            ...
            //}
            //myStr += "};";
            //StreamWriter streamWriter = System.IO.File.CreateText("DataBase.txt");
        ...
        public IActionResult ProductsDetailByCategory(string lang)
        {
            Setlanguage(lang);
            return View();
        }
